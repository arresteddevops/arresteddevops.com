...
task :pingomatic do
  begin
    ...
    XMLRPC::Client.new('rpc.pingomatic.com', '/').call('weblogUpdates.extendedPing', 'Ewal.net' , 'http://www.arresteddevops.com', 'http://www.arresteddevops.com/atom.xml')
  rescue LoadError
...
task :sitemapgoogle do
  begin
    ...
    Net::HTTP.get('www.google.com', '/webmasters/tools/ping?sitemap=' + URI.escape('http://www.arresteddevops.com/sitemap.xml'))
  rescue LoadError
...
task :sitemapbing do
  begin
    ...
    Net::HTTP.get('www.bing.com', '/webmaster/ping.aspx?siteMap=' + URI.escape('http://www.arresteddevops.com/sitemap.xml'))
  rescue LoadError
